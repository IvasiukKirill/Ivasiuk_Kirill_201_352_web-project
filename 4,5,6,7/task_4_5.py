...
spisok = command1.split()
spisok2 = command2.split()
spisokVlans=spisok[-1].split(',')
spisok2Vlans=spisok2[-1].split(',')
setVlans=set(spisokVlans)
set2Vlans=set(spisok2Vlans)
result=setVlans&set2Vlans
print (sorted(result))
