...
int searh(char* str, int size, char* substr, int len, int* arr)//поиск подстроки в строке
{
    int s = 0;
...
void Salat(char* str, int size)//шифр сдвига на 3
{
...
char* Quotes(char* str, int size, char* Array)//текст внутри скобок
{
