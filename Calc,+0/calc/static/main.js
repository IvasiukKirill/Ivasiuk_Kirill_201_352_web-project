...
function clickHandler(event) {
    if (event.target.className == 'key digit') {
        ...
        document.querySelector('span').append(digit);
    }
    if (event.target.className == 'key operation') {
        let operation = event.target.innerHTML;
        document.querySelector('span').append(operation)
    }
    if (event.target.className == 'key bracket') {
        let bracket = event.target.innerHTML;
        document.querySelector('span').append(bracket)
    }
    if (event.target.className == 'key clear') {
        document.querySelector('span').innerHTML = '';
    }
    if (event.target.className == 'key result') {
        let str = document.querySelector('span').innerHTML;
        let result = evaluate(compile(str));
